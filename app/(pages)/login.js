...
export const Input = (props) => (<TextInput onChangeText={props.onChangeText} value={props.value} placeholder={props.placeholder} secureTextEntry={props.secureTextEntry}>
    </TextInput>);
const confirmPasswordsMatch = (confirmationPassword, password) => {
...
export default function Login() {
    ...
    return (<View style={styles.container}>
            ...
            <Button onPress={() => handleSignin(username, password)} title='Log In'/>
        </View>);
}
