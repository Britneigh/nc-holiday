  ...
  useEffect(() => {
    ...
    getTripById(id)
      .then((fetchedTrip) => {
        ...
        console.log(fetchedTrip.pictures[0], "<===picture")
        setTrip(fetchedTrip);
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        {!trip && <Text>No trip data available</Text>}
        {trip && (
          <>
            <Image
              style={styles.cardImg}
              source={
                trip.pictures && trip.pictures[0]
                  ? { uri: trip.pictures[0] }
            ...
            <Text>
              Start Date: {trip.startDate.toDate().toLocaleDateString()}
            </Text>
